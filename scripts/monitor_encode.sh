...
STDOUT_FILE="${HOME_DIR}/DNA-Aeon/logs/encode/debug/stdout_debug.log"
STDERR_FILE="${HOME_DIR}/DNA-Aeon/logs/encode/debug/stderr_debug.log"
...
python3 ${PROGRAM_PATH} -c "${HOME_DIR}/DNA-Aeon/configs/config-files/config.json" 1>${STDOUT_FILE} 2>${STDERR_FILE}
